...
var Messenger = function () {
  function Messenger(project, target) {
    ...
    (0, _utils.invariant)(this.target.postMessage, 'Messenger\'s target should be a contentWindow.');
  ...
  _createClass(Messenger, [{
    ...
    value: function on(channel, listener) {
      ...
      if (this.channelListeners.length === 0) {
        ...
        (0, _utils.listen)(this.listener); // 注册 on message 方法
      }
    ...
    value: function _check() {
      ...
      if (this.channelListeners.length === 0 && this.listener) {
        (0, _utils.unListen)(this.listener); // 取消注册 on message 方法
        this.listener = null;
      }
    }
